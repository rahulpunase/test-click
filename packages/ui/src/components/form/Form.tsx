...
const FormBase = React.forwardRef<
  HTMLFormElement,
  React.FormHTMLAttributes<HTMLFormElement>
>(({ className, ...props }, ref) => {
  return <form ref={ref} className={formVariants({ className })} {...props} />;
});
...
const Controller = Object.assign(FormController, {
  Item: FormItem,
